...
def main():
    ...
    dataset_files = {
        ...
        'mams': {
            'train': './DualGCN/dataset/MAMS_stanza/train.json',
            'test': './DualGCN/dataset/MAMS_stanza/test.json',
        },
        'mamssmall': {
            'train': './DualGCN/dataset/MAMS_small/train_xpos.json',
            'test': './DualGCN/dataset/MAMS_small/test_xpos.json',
        }
    }
